...
public class ParticipantViewParticipantListAdapter extends ArrayAdapter<ParticipantItem> {
    private Context context;
    private final List<ParticipantItem> values;

    public ParticipantViewParticipantListAdapter(@NonNull Context context, @NonNull List<ParticipantItem> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (entityView == null || view1 == null) {
            ...
            entityView = layoutInflater.inflate(R.layout.page_participants_list_participants_view, parent, false);
            view1 = entityView.findViewById(R.id.tv_listview_partic_name);
        }
